var app = new Vue({
    ...
    methods: {
        async getLessons() {
            var res = await fetch(`${this.baseURL}collection/Products`);
        ...
        async searchLessons() {
            ...
            var res = await fetch(`${this.baseURL}search/collection/Products`, {
                method: "POST",
        ...
        async submitOrder() {
            ...
            this.cart.forEach((item) => {
                fetch(`${this.baseURL}collection/Products/${item.lesson._id}`, {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
